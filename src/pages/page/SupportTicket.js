    ...
    <div className="md:px-6 sm:px-3 pt-4">
      <div className="container-fluid">
          ...
          <div className="md:p-6 p-4">
            <div className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-4 md:mb-6 mb-4">
              ...
              <div className="p-4 rounded-xl border border-dashed border-border-color">
                ...
                <div className="flex items-end gap-2">
                  <span className="font-bold text-[24px]/[30px]">55</span>
                  <span className="flex items-end">
                    8%
                    <IconCaretUpFilled className="w-[16px] h-[16px] min-w-[16px]" />
                  </span>
              ...
              <div className="p-4 rounded-xl border border-dashed border-border-color">
                ...
                <div className="flex items-end gap-2">
                  <span className="font-bold text-[24px]/[30px]">8</span>
                  <span className="flex items-end">
                    2%
                    <IconCaretUpFilled className="w-[16px] h-[16px] min-w-[16px]" />
                  </span>
              ...
              <div className="p-4 rounded-xl border border-dashed border-border-color">
                ...
                <div className="flex items-end gap-2">
                  <span className="font-bold text-[24px]/[30px]">105</span>
                  <span className="flex items-end">
                    18%
                    <IconCaretUpFilled className="w-[16px] h-[16px] min-w-[16px]" />
                  </span>
            ...
            <div className="flex items-stretch gap-y-2 gap-x-4 sm:flex-row flex-col md:mb-6 mb-4">
              <div className="floating-form-control flex-1">
                ...
                />
                <label htmlFor="findTicket" className="form-label">
                  Find Ticket...
                </label>
              </div>
              <div className="flex gap-4">
                <button className="btn btn-primary">Search</button>
                <button className="btn btn-secondary">Add new ticket</button>
              </div>
            </div>
        ...
        <div className="md:mb-6 mb-4">
          <h5 className="font-medium text-[20px]/[26px]">Showing 8 Ticket</h5>
          <p className="text-font-color-100 small">Based your preferences</p>
        </div>
