            ...
            <TabPanel>
              <div className="grid xxl:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
                <div className="card bg-card-color rounded-xl md:p-6 p-4 border border-dashed border-border-color">
                  ...
                  <div className="mb-4">
                    <p className="line-clamp-2">
                      ...
                      typesetting a galley of type and scrambled it... Lorem
                      Ipsum is simply dummy text of the printing and typesetting
                      a galley of type and scrambled it... Lorem Ipsum is simply
                      dummy text of the printing and typesetting a galley of
                      type and scrambled it... Lorem Ipsum is simply dummy text
                      of the printing and typesetting a galley of type and
                      scrambled it... Lorem Ipsum is simply dummy text of the
                      printing and typesetting a galley of type and scrambled
                      it...
                    </p>
                  ...
                  <ul className="flex gap-8 flex-wrap mb-6">
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">124</h6>
                      <small className="text-font-color-100">Attachments</small>
                    </li>
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">452</h6>
                      <small className="text-font-color-100">Comments</small>
                    </li>
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">85</h6>
                      <small className="text-font-color-100">Tasks</small>
                    </li>
                  </ul>
                  ...
                  <div className="flex items-center justify-between gap-2 small">
                    Task completed :<span>78/85</span>
                  </div>
                ...
                <div className="card bg-card-color rounded-xl md:p-6 p-4 border border-dashed border-border-color">
                  ...
                  <ul className="flex gap-8 flex-wrap mb-6">
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">23</h6>
                      <small className="text-font-color-100">Attachments</small>
                    </li>
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">105</h6>
                      <small className="text-font-color-100">Comments</small>
                    </li>
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">37</h6>
                      <small className="text-font-color-100">Tasks</small>
                    </li>
                  </ul>
                  <div className="flex items-center flex-wrap gap-1 mb-4">
                  ...
                  <div className="flex items-center justify-between gap-2 small">
                    Task completed :<span>23/37</span>
                  </div>
                  <div className="progress overflow-hidden h-[3px] bg-border-color rounded-full mt-2">
                ...
                <div className="card bg-card-color rounded-xl md:p-6 p-4 border border-dashed border-border-color">
                  ...
                  <ul className="flex gap-8 flex-wrap mb-6">
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">45</h6>
                      <small className="text-font-color-100">Attachments</small>
                    </li>
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">210</h6>
                      <small className="text-font-color-100">Comments</small>
                    </li>
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">37</h6>
                  ...
                  <div className="flex items-center justify-between gap-2 small">
                    Task completed :<span>12/47</span>
                  </div>
                  <div className="progress overflow-hidden h-[3px] bg-border-color rounded-full mt-2">
                ...
                <div className="card bg-card-color rounded-xl md:p-6 p-4 border border-dashed border-border-color">
                  ...
                  <div className="flex items-center justify-between gap-2 small">
                    Task completed :<span>55/85</span>
                  </div>
                  <div className="progress overflow-hidden h-[3px] bg-border-color rounded-full mt-2">
                ...
                <div className="card bg-card-color rounded-xl md:p-6 p-4 border border-dashed border-border-color">
                  ...
                  <div className="flex items-center justify-between gap-2 small">
                    Task completed :<span>19/37</span>
                  </div>
                  <div className="progress overflow-hidden h-[3px] bg-border-color rounded-full mt-2">
              ...
              <div className="grid xxl:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
                ...
                <div className="card bg-card-color rounded-xl md:p-6 p-4 border border-dashed border-border-color">
                  ...
                  <ul className="flex gap-8 flex-wrap mb-6">
                    ...
                    <li>
                      <h6 className="text-[20px]/[26px] font-medium">47</h6>
                      <small className="text-font-color-100">Tasks</small>
                    </li>
                  </ul>
                  <div className="flex items-center flex-wrap gap-1 mb-4">
