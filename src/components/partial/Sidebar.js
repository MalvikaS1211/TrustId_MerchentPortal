...
export default function Sidebar({
  ...
  return (
    <>
      {/* <div className="sidebar-header px-3 mb-6 flex items-center justify-between gap-2 py-3"> */}
      <div className="sidebar-header px-3  flex items-center justify-between gap-2 sticky top-0 z-[5] bg-body-color py-3">
        ...
        {/* <div className="sidebar-dropdown relative flex">
          ...
          >
            <li>
              <Link to="#" className="px-4 py-2 flex hover:bg-gray-100">
                Landing page
              </Link>
            </li>
            <li>
      ...
      <div className="sidebar-bottom-link flex justify-evenly gap-3 mx-3 p-2 mt-auto custom-sidebar">
        <button
